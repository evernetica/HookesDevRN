...
import TutorialAddToSafariScreen from './components/TutorialAddToSafariScreen';
const Tutorial = () => {
  ...
  const isLastStep = currentStep === tutorialStepsData.length - 1;
  ...
  return (
    <Block bg={'white'} height={'100%'}>
      ...
      {isLastStep && <TutorialAddToSafariScreen />}
    </Block>
  );
};
